...
export default {
  name: 'DialogHistoryTransactionInDate',
  ...
  methods: {
    ...
    onGetListNoteGolfer() {
      ...
      listGolferResources.historyTransactionInDateUser(this.listQuery).then(response => {
    ...
    async handleDownload() {
      ...
      while (!stop) {
        try {
          const res = await listGolferResources.historyTransactionInDateUser(query)
          console.log('res..............', res)
