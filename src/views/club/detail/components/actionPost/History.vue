    ...
    justify-content: space-between; "
          >
            ...
            <div>
              ...
              <p style="margin: 0; font-size: 14px; " v-html="item.text" />
              <p style="margin: 0; font-size: 12px; color: #999; font-style: italic;">{{ item.time }}</p>
            </div>
          </div>
      ...
      list_post: [
        {
          ...
          text: '<span>Đã duyệt bài đăng của <b>Nam chen 12345</b></span>',
